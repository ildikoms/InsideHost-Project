...
namespace InsideHostSystem
{
    public class DBConnect
    {
        ...
        // Member loginStatus módosítása
        public string BuildUpdateQuery(string table, int loginStatus, params string[] values)
        {
            string updateQuery = null;
            updateQuery = "UPDATE " + table + " SET LoginStatus="+ loginStatus+" WHERE MemberName='" + values[0] + "'";
            return updateQuery;
        }
        ...
        /// <summary>
        /// Member loginStatus lekérdezése
        /// </summary>
        /// <param name="table"></param>
        /// <param name="name"></param>
        /// <returns></returns>
        public string BuildSelectQuery(string table, string name)
        {
            string selectQuery = null;
            selectQuery = "SELECT MemberName, MemberPass, LoginStatus FROM "+table+" WHERE  MemberName= '" + name + "')";
            return selectQuery;
        }
